...
public class composerLayout extends RelativeLayout{
    ...
    private composerAnimations myani; // 動畫類
    ...
    public void init(int[] imgResId, int showhideButtonId, int crossId,
        ...
        myani = new composerAnimations(rl1, pCode, radius);
        rlButton.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                if (areButtonsShowing) {
                    myani.startAnimationsOut(duretime);
                    cross.startAnimation(composerAnimations.getRotateAnimation(-270,
                            0, duretime));
                } else {
                    myani.startAnimationsIn(duretime);
                    cross.startAnimation(composerAnimations.getRotateAnimation(0,
                            -270, duretime));
                }
        ...
        cross.startAnimation(composerAnimations.getRotateAnimation(0, 360, 200));
        this.addView(rl1);
    ...
    public void collapse() {
        myani.startAnimationsOut(duretime);
        cross.startAnimation(composerAnimations.getRotateAnimation(-270, 0, duretime));
    ...
    public void expand() {
        myani.startAnimationsIn(duretime);
        cross.startAnimation(composerAnimations.getRotateAnimation(0, -270, duretime));
